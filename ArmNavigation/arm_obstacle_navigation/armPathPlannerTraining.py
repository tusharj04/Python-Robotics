...
training_set_y = tf.keras.preprocessing.image_dataset_from_directory(
    ...
    label_mode='categorical',
    batch_size=32,
    image_size=(256, 256))#what type of class mode is it
...
model.fit(training_set_x, training_set_y, validation_data=(test_set_x, test_set_y), epochs=1000, verbose=1, callbacks=[early_stop, save_weights])
